...
@section('UserActiveGivr','active open')
...
@section('pagecontent')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="fa fa-thumbs-up"></i>GIVR
                                           ...
                                           class="list-group-item @if($key==0) active @endif">
                                            <span class="pull-left">@if($value['username'] && $value['username'] !=""){{$value['username']}}@else
                                                    Guest @endif<br><span
                                                        ...
                                                        data-value="{{$value['email']}}">{{$value['email']}}</span></span><span
                                                    class="pull-right copy_device_id" title="copy device id"
                                                    data-title="Copy device id"
                                                    data-value="{{$value['device_id']}}">{{$value['device_id']}}</span>
                                        </a>
                                        <input type="text" id="copyText{{$value['device_id']}}"
                                               value="{{$value['device_id']}}"
                                               style="position: absolute; left: -9999px;">
                                        <input type="text" id="copyText{{$value['email']}}"
                                               value="{{$value['email']}}"
                                               style="position: absolute; left: -9999px;">
                                    @endforeach
                                    <input type="text" id="first_activity_id"
                                           value="@if(isset($recentActivity[0])) {{$recentActivity[0]['activity_id']}} @endif"
                                           hidden>
                                @endif
                            </div>
                        </div>
                                                    ...
                                                    <div class="col-sm-6  timeline-item">
                                                        <div class="row">
                                                            <div class="col-sm-8">
                                                                ...
                                                                <p class="custom_date_right">{{date("d-m-Y  h:i:s"),$msg['timestamp_of_action']}}
                                                                    <span style="font-size: 12px;color: #808080;">@if(isset($msg['time'])) {{$msg['time']}} @endif</span>
                                                                </p>
                                                    ...
                                                    <div class="col-sm-6  timeline-item">
                                                        <div class="row">
                                                            <div class="col-sm-9 col-sm-offset-3">
                                                                <p class="custom_date_left">{{date("d-m-Y  h:i:s"),$msg['timestamp_of_action']}}
                                                                    {{--                                                                <p class="custom_date_left">{{$msg['timestamp_of_action']}}--}}
                                                                    <span
                                                                            style="font-size: 12px;color: #808080;">@if(isset($msg['time'])) {{$msg['time']}} @endif</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#boxscroll2').scroll(function (e) {
                ...
                if (iCurScrollPos < iScrollPos) {
                    if (!scrolled) {
                        scrolled = true;
                        $.ajax({
                            url: '/admin/getActivityDetailsGivr',
                            type: 'get',
                            dataType: 'json',
            ...
            $(document.body).click('.custom_email', function () {
                $.ajax({
                    url: '/admin/activityLogsAjaxHandlerGivr',
                    type: 'get',
                    dataType: 'json',
            ...
            function createActivityDiv(msg) {
                ...
                $.each(msg, function (i, o) {
                    if (o.visit_duration == '' ) {
                        console.log('------------',o.visit_duration);

                        time2 = '<small class="text-muted pull-right"><i class="glyphicon"></i></small>'
                    } else {
