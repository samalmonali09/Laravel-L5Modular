...
{{--* User: Monali Samal<monalisamal@globusssoft.in>--}}
{{--* Date: 2/21/2018--}}
{{--* Time: 1:45 PM--}}
{{--*/--}}
{{--ManageUser GIVR--}}
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/manageUser/GIVR">Manage Users</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/manageUser/GIVR"><i class="fa fa-eye-slash"></i>Get Instant Views Russian</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
                                ...
                                <tr role="row" class="filter">
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control form-filter input-sm"
                                               name="method" value="GIVR" style="display: none;">
                                    </td>
                                </tr>
                                </thead>
                                <tbody>
        ...
        <div class="modal fade" id="editUserModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <strong><input type="email" name="Email" autocomplete="off"
                                                           ...
                                                           required class="form-control"/></strong>
                                        </td>
                                    </tr>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-warning Closebutton" data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-success updateGeneralInfo" value="Load Data">
...
$(document).ready(function () {
    ...
    // js for groupbox  check functionality
    ...
    // js for  extra details  showdetails functionality ...
    var userId;
    ...
    // js for  edit details fucntionality ,,,
    var userId;
    ...
    // js for  update data fucntionality
