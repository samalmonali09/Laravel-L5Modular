    ...
    <div class="page-bar">
        ...
        <div class="theme-panel hidden-xs hidden-sm">
            ...
            <span>
                ...
                {{--<ul class="dropdown-menu registeredThrough">--}}
        ...
        <div class="row">
                ...
                <div class="dashboard-stat green">
                    ...
                    <div class="details">
                        <div class="number" id="payment_time">
                            {{$transctionMoney[0]['payment_time']}}
                        </div>
                        <div class="desc">
                            Today's Income
                        </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 Subscriptions" hidden>
                <div class="dashboard-stat blue-dark">
                    ...
                    <div class="details">
                        {{--<div class="number" id="Subscriptions">--}}
                            {{--10--}}
                        {{--</div>--}}
                        <div class="number" id="totalrecurring">
                            {{$recurringMoney[0]['totalrecurring']}}
                        </div>
                        <div class="desc">
                            Total Subscriptions
                        </div>
                ...
                <div class="dashboard-stat blue-soft">
                    ...
                    <div class="details">
                        ...
                        <div class="number" id="ActiveReq">
                            {{$recurringMoney[0]['ActiveReq']}}
                            {{--{{dd($subscriptionMoney[0])}}--}}
                        </div>
                        <div class="desc">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response['status'] == 200) {
                        ...
                        $('.redirectUser').attr('href', '{{env('APP_URL1')}}/admin/manageUser/' + redirectUrl[registeredThrough - 1]);
                        $('.redirectOrder').attr('href', '{{env('APP_URL1')}}/admin/manageOrders/' + redirectUrl[registeredThrough - 1]);
                        $('.redirectTransction').attr('href', '{{env('APP_URL1')}}/admin/manageTransaction/' + redirectUrl[registeredThrough - 1]);
                        $('.redirectSubcription').attr('href', '{{env('APP_URL1')}}/admin/PaymentDatable/');
