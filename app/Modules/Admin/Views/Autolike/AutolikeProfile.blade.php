...
@section('pagecontent')
                                ...
                                <table class="table table-responsive table-hover" id="viewTable">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="error" style="color:red">{{ $errors->first('insta_username') }}</div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <strong><input type="text" class="form-control" name="post_limit"
                                                ...
                                                /> </strong>
                                            <div class="error" style="color:red">{{ $errors->first('post_limit') }}</div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="error" style="color:red">{{ $errors->first('post_done') }}</div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="error" style="color:red">{{ $errors->first('daily_post_done') }}</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <table class="table table-responsive table-hover" id="viewTable">
                                ...
                                {{--<tr>--}}
                                    {{--<td colspan="2">--}}
                                        {{--<label><b>Insta Username :</b></label>&nbsp; <i class="fa fa-instagram"></i><a--}}
                                                {{--class="btn btn-xs default text-case link-width" id="insta_username1" href=""  data-toggle="modal"  target="_blank"></a>--}}
                                ...
                                <tr>
                                    {{--<td colspan="2">--}}
                                    {{--<label><b>Last_checked_time : </b></label>&nbsp; <span--}}
                                    {{--id="last_checked_time1"></span>--}}
                                    {{--</td>--}}
                                </tr>
                                ...
                                {{--<td colspan="2">--}}
                                {{--<label><b>Last_delivered_link :</b></label>&nbsp; <span--}}
                                {{--id="last_delivered_link"></span>--}}
                                {{--</tr>--}}
                                {{--</td>--}}
                                ...
                                {{--<td colspan="2">--}}
                                {{--<label><b>Last_delivered_link :</b></label>&nbsp;--}}
                                {{--<strong id="last_delivered_link"><a href="" taregt="_blank"></a></strong>--}}
                                {{--<button class="btn btn-sm btn-default showorderDetails" data-toggle="modal"--}}
                                {{--data-target="#viewAll"> view all--}}
                                {{--</button>--}}
                                {{--<button class="btn btn-default pull-right orderDetails" data-toggle="modal" data-target="#viewAll">VIEW ALL</button>--}}
                                {{--</td>--}}
                                {{--</tr>--}}
                                {{--<tr>--}}
                                {{--<td colspan="2">--}}
                                {{--<button style="cursor: pointer;" id="comments"><b>Comments :</b></button>&nbsp;--}}
                                {{--</td>--}}
                                {{--<td>--}}
    ...
    {{--<div id="viewAll" class="modal fade" tabindex="-1" role="dialog">--}}
    {{--<div class="modal-dialog">--}}
    {{--<div class="modal-content">--}}
    {{--<div class="modal-header"--}}
    {{--style="background: #1e4f66; color: #fff;text-align: center;"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>--}}
    ...
    {{--<tr>--}}
    {{--<td colspan="2">--}}
    {{--<label><b>Order_url :</b></label>&nbsp; <i class="fa fa-instagram"></i><a--}}
