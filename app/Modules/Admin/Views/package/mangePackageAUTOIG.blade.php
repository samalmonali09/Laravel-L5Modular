    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/managePackage/AUTOIG">AUTOIG</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/managePackage/AUTOIG">Manage Packages</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <div style="float: right">
                            ...
                            <a href="/admin/AddingPackages/AUTOIG">
                    ...
                    <div class="table-container">
                        ...
                        <table class="table table-responsive table-striped table-bordered table-hover"
                            ...
                            <tr role="row" class="heading">
                                <th width="10%"><input type="checkbox" id="groupCheckbox"></th>
                                <th width="10%">
                                    Id
                                </th>
                                <th width="15%">
                    ...
                    <div class="modal-body">
                        <form class="form" role="form" id="edit_usernameForm">
                            ...
                            <div class="form-group floating-label col-md-6">
                                ...
                                <div class="error" style="color:red">{{ $errors->first('package_status') }}</div>
...
// js for show details  Functionality  ************************************************
        ...
        /*$('#editUserModal').on('show.bs.modal', function () {
            // $('#datatable_ajax').DataTable().ajax.reload();
            testing($(".packagedata option:selected").attr('type'))
            // $('#editUserModal').modal('hide').find("input[name=plan_name][name=package_type]").val('').end();
        ...
        $('#editUserModal').on('hidden.bs.modal', function (e) {
            ...
            $('#editUserModal').modal('hide').find("input[name=plan_name],input[name=package_type]").val('').end();
        });*/
