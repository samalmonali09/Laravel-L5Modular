    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/managePackage/Instant">Instant</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/managePackage/Instant">Manage Packages</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <div style="float: right">
                            ...
                            <a href="/admin/AddingPackages/Instant">
