...
@section('pagecontent')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="/admin/EmergencySwitch">Emergency Switch </a>
            </li>
        </ul>
    </div>
    <div class="col-md-4 col-md-offset-4">
        <div class="card" style="margin: 15px; border:1px solid #ccc; padding: 20px; font-size: 16px;">
            ...
            Emergency Module <input data-toggle="toggle" type="checkbox" id="checkbox" style="float: right;">
        </div>
    </div>
...
//            $('#checkbox').on('switchChange.bootstrapSwitch', function (e, data) {
            $("#checkbox").change(function () {
                ...
                $.ajax({
                    url: '/admin/Emergency-SwitchAUTOIG',
                    dataType: 'json',
                    type: 'post',
                    data: {
