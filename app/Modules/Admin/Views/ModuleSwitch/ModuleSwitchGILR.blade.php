...
@section('pagecontent')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="/admin/module-statusGILR">Module Switch </a>
            </li>
        </ul>
    </div>
    ...
    <div class="col-md-6">
        ...
        <div class="card" style="margin: 15px; border:1px solid #ccc; padding: 10px 10px 20px 10px; font-size: 16px;">
            Activity Tracker <input data-toggle="toggle" type="checkbox" value="{{$Tracker}}"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#checkbox").change(function () {
                ...
                $.ajax({
                    url: '/admin/module-statusGILR',
                    dataType: 'json',
                    type: 'post',
                    data: {
                        'module_switchGILR': message
                    },
            ...
            $("#Trackcheckbox").change(function () {
                ...
                if ($(this).parent().hasClass('btn-primary')) {
                    ...
                    if (time == 0) {
                        ...
                        $.ajax({
                            url: '/admin/ActivityTrackerGILR',
                            dataType: 'json',
                            type: 'post',
                            data: {
                                'Activity_trackerGILR': message,
                                'time': time
                            }
                        })
                    }
