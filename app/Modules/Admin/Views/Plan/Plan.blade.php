                                ...
                                <table class="table table-responsive table-hover" id="viewTable">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="error"
                                                 style="color:red">{{ $errors->first('min_quantity') }}</div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="error"
                                                 style="color:red">{{ $errors->first('max_quantity') }}</div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="error"
                                                 style="color:red">{{ $errors->first('buying_price') }}</div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="error"
                                                 style="color:red">{{ $errors->first('selling_price') }}</div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="error"
                                                 style="color:red">{{ $errors->first('supplier_server_Id') }}</div>
