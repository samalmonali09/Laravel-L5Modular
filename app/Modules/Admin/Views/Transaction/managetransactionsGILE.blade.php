...
@section('GILE','active open')
@section('GILEMTH','active open')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/manageTransaction/GILE">Get Instant Likes En</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/manageTransaction/GILE">Manage Transaction</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover"
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            ...
                                            <input type="text" class="form-control form-filter input-sm"
                                                   name="method" value="GILE" style="display: none;">
                                        </td>
                                        {{--<td>--}}
                ...
                <div class="modal-dialog modal-lg" style="margin: 5% 18%;">
                    <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-responsive table-hover" id="viewTable">
                                        ...
                                        {{--<td colspan="2">--}}
                                        {{--<label> <b>Autolikes Id: </b></label>&nbsp; <span--}}
                                        {{--id="autolikes_id"></span>--}}
                                        ...
                                        <tr>
                                            {{--<tr>--}}
                                            {{--<td colspan="2">--}}
                                            {{--<label> <b>Tx Mode: </b></label>&nbsp; <span id="tx_mode"></span>--}}
                                            {{--</td>--}}
                                            {{--</tr>--}}
                                            {{--<tr>--}}
                                            {{--<td colspan="2">--}}
                                            {{--<label> <b>Amount: </b></label>&nbsp;&nbsp;&nbsp;<i class="fa fa-dollar"></i>&nbsp;&nbsp;<span--}}
                                            {{--id="amount1"></span>--}}
                                            {{--</td>--}}
                                            {{--</tr>--}}
                                        </tr>
                                        ...
                                        <tr>
                                        {{--<td colspan="2">--}}
                                        {{--<label><b>Package Id : </b></label>&nbsp; <span id="package_id"></span>--}}
                                        {{--</td>--}}
                                        <tr>
                                            <td colspan="2">
                                        ...
                                        <tr>
                                            {{--<td colspan="2">--}}
                                                {{--<label><b>Extra Details : </b></label>&nbsp; <span--}}
                                                        {{--id="extra_details"></span>--}}
                                            {{--</td>--}}
                                        </tr>
                                        </td>
                                        </tr>
                        ...
                        <div class="modal-footer">
                            {{--style="background: linear-gradient(-45deg, #4d0d11, #105f80); color: #ffd1a1;">--}}
...
@section('pagescripts')
    ...
    {{--<script type="text/javascript" src="/GAIA/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>--}}
