...
class ViralBoostController extends Controller
{


    /**
     * @Desc: imagesUploadBoost
     * @param Request $request
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     * @since  25/5/2018
     * @author Monali Samal (monalisamal@globussoft.in)
     */
    public function imagesUploadBoost(Request $request)
    {
        $whereForAnd = [
        ...
        return view('Admin::Banner.viralboost', ['androidBanner' => $androidBannerDetails, 'iosBanner' => $iosBannerDetails]);
    ...
    /**
     * @Desc: imageupdateForIOS(update Image for Ios)
     * @param Request $request
     * @since  25 may 2018
     * @author Monali Samal (monalisamal@globussoft.in)
     */
