                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed">
                            ...
                            @if(isset($decoded['item_number']))
                                @if(isset($decoded['item_number']['likes']) && $decoded['item_number']['likes'] == "on")
                                    <tr>
                                        ...
                                        <td class="text-center">${{$decoded['item_number']['likes_price_per_k']/1000 * $decoded['item_number']['likes_quantity']}}</td>
                                ...
                                @if(isset($decoded['item_number']['views']) && $decoded['item_number']['views'] == "on")
                                    <tr>
                                        ...
                                        <td class="text-center">${{$decoded['item_number']['views_price_per_k']/1000 * $decoded['item_number']['views_quantity']}}</td>
                                        {{--<td class="text-right">$900</td>--}}
                                    </tr>
                                @endif
                                @if(isset($decoded['item_number']['comments']) && $decoded['item_number']['comments'] == "on")
                                    <tr>
                                        ...
                                        <td class="text-center">${{$decoded['item_number']['comments_price_per_k']/1000 * $decoded['item_number']['comments_quantity']}}</td>
                                        {{--<td class="text-right">$900</td>--}}
                                    </tr>
                                @endif
                                @if(isset($decoded['item_number']['impressions']) && $decoded['item_number']['impressions'] == "on")
                                    <tr>
                                        ...
                                        <td class="text-center">${{$decoded['item_number']['impressions_price_per_k']/1000 * $decoded['item_number']['impressions_quantity']}}</td>
                                        {{--<td class="text-right">$900</td>--}}
                                    </tr>
                                @endif
                            @endif
                            <tr>
                                ...
                                <td class="highrow text-right">${{$decoded['item_number']['total_price']}}<sup>*</sup></td>
                            </tr>
                            <tr>
                                <td class="emptyrow" colspan="3"><small style="color: #4A4A4A; margin-left: 10px;"><i><sup>*</sup> VAT will be included based on location</i></small></td>
