            ...
            <div class="modal-header">
                <?php if(Session::has('message')): ?>
                    <?php if(session('status')=='Success'): ?>
                        <div style="color:green;"><b><?php echo e(session('status')); ?></b> <?php echo e(Session::get('message')); ?> <a
                                    href="/admin/commentTable">Go Back</a></div>
                    <?php elseif(session('status')=='Error'): ?>
                        <div style="color:red;"><b><?php echo e(session('status')); ?></b> <?php echo e(Session::get('message')); ?></div>
                    <?php endif; ?>
                <?php endif; ?>
