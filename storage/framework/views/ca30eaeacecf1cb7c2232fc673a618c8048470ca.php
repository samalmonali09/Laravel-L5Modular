...
<?php $__env->startSection('tutorialimg', 'active open'); ?>
    ...
    <div>
        ...
        <div class="col-md-10 col-md-offset-1 card"
            ...
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="row list-card" id="row-<?php echo e($d['id']); ?>">
                    <div class="col-md-12"
                        ...
                        <div class="col-md-2">
                            <a href="<?php echo e($d['link']); ?>"
                               ...
                               id="thumbnail-link-<?php echo e($d['id']); ?>">
                                <img src="<?php echo e($d['thumbnail']); ?>"
                                     id="thumbnail-<?php echo e($d['id']); ?>"
                                     width="120"
                                     height="90">
                            </a>
                        </div>
                        ...
                        <span>
                            <strong>
                                <a href="<?php echo e($d['link']); ?>"
                                   target="_blank"
                                   rel="noopener noreferrer"
                                   id="title-<?php echo e($d['id']); ?>">
                                    <?php echo e($d['title']); ?>

                                </a>
                            </strong>
                        </span>
                            <p id="description-<?php echo e($d['id']); ?>"><?php echo e($d['description']); ?>...</p>
                        </div>
                        <div class="col-md-2">
                            <div style="padding: 15px 0px">
                                <span>
                                    <a onclick="showEditModal(<?php echo e($d['id']); ?>)"
                                ...
                                <span>
                                    <a class="delete-url"
                                       onclick="deleteTutorial(<?php echo e($d['id']); ?>)"
                                       style="cursor: pointer">
