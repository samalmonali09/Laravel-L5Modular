...
<?php $__env->startSection('UserActiveGivr','active open'); ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-8">
                                                                ...
                                                                <p class="custom_date_right"><?php echo e(date("d-m-Y  h:i:s"),$msg['timestamp_of_action']); ?>
                                                                    ...
                                                                    <span style="font-size: 12px;color: #808080;"><?php if(isset($msg['time'])): ?> <?php echo e($msg['time']); ?> <?php endif; ?></span>
                                                                </p>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-9 col-sm-offset-3">
                                                                <p class="custom_date_left"><?php echo e(date("d-m-Y  h:i:s"),$msg['timestamp_of_action']); ?>
                                                                    ...
                                                                    <span
                                                                            style="font-size: 12px;color: #808080;"><?php if(isset($msg['time'])): ?> <?php echo e($msg['time']); ?> <?php endif; ?></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
