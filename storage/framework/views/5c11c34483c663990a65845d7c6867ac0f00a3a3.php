...
<?php $__env->startSection('GILE','active open'); ?>
<?php $__env->startSection('GILEMO','active open'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/manageOrders/GILE">Manage Orders</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/manageOrders/GILE"><i class="fa fa-heart"></i>Get Instant Likes English</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" title="search_order_id"
                                                   name="search_order_id" width="100%">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="margin-bottom-5">
                                                <button class="btn btn-xs btn-primary filter-submit margin-bottom" title="search"><i
                ...
                <div class="modal-dialog">
                    <div class="modal-content buylikesmodal" style="border: 3px solid;" data-animation="false">
                        ...
                        <div class="modal-body">
                            <ul class="list-group">
                                <li class="list-group-item center;"><span id="comments1"></span></li>
...
//                    initPickers();
        ...
        // js for Exta Details Functionality.................
        var order_id;
        var comment_id;
        $(document.body).on('click', '.show-details', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    console.log(res);
                    if (res['status'] == 200) {
//                        $('#autolikes_id').text(res.userDetails.autolikes_id);
...
//                        $('#orders_per_run').text(res.userDetails.orders_per_run);
