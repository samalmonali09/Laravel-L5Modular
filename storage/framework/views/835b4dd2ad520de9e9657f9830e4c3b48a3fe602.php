...
<?php $__env->startSection('GIVEMO','active open'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/manageOrders/GIVE">Manage Orders</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/manageOrders/GIVE"><i class="fa fa-eye"></i> Get Instant Views English</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
