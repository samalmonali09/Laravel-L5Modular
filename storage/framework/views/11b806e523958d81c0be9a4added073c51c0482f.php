...
<?php $__env->startSection('GIL','active open'); ?>
<?php $__env->startSection('ILMU','active open'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/manageUser/Instant">Manage Users</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/manageUser/Instant"><i class="fa fa-heart"></i> Instant Likes</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <div style="float: right">
                            <a href="/admin/AddingUser/Instant">

                                <button class="btn blue pull-right" data-toggle="modal" title="adduser"
...
//   Changed Button Status Functionality ..........................
