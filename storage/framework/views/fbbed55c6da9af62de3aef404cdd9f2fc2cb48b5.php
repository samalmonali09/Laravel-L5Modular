...
<?php $__env->startSection('GILRMU','active open'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/manageUser/GILR">Manage Users</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/manageUser/GILR"><i class="fa fa-heart"></i>Get Instant Likes Russian</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
...
<?php $__env->startSection('pagescripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            // js  for  groupbox  check fucntionality..
