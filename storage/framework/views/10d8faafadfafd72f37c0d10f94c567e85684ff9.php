...
<?php $__env->startSection('AUTOIGO','active open'); ?>
...
<?php $__env->startSection('pagecontent'); ?>
    ...
    <h3 class="page-title" style="color: #19658b">
        Manage Orders AUTOIG
    </h3>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <i class="fa fa-home"></i>
                <a href="/admin/manageOrders/AUTOIG">Manage Orders</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/manageOrders/AUTOIG"><i class="fa fa-heart"></i>AUTOIGO</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
