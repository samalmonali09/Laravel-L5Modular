...
<?php $__env->startSection('GILEMU','active open'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/manageUser/GILE">Manage Users</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/manageUser/GILE"><i class="fa fa-heart"></i>Get Instant English</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
...
// ChangeStatus Action  button Functionality in javascript
            $(document.body).on('click', '.changeStatus', function () {
                ...
                var y = confirm('Are you sure to changeStatus ');
                if (y) {
                    $.ajax({
            ...
            // js for  extra  show details  functionality.....
            var userId;
...
//
            ...
            // js for  edit users  functioanlity ...
