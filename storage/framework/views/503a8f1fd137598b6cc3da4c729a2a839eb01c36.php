                                ...
                                <table class="table table-responsive table-hover" id="viewTable">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="error"
                                                 style="color:red"><?php echo e($errors->first('sub_package_name')); ?></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group floating-label col-md-10">
                                                    <div>
                                                        <?php if(($errors->first('daily_price') !== "") ||($errors->first('daily_billing_frequency') !== "") || ($errors->first('daily_post_limit') !== "") || ($errors->first('daily_daily_post_limit') !== "") || ($errors->first('plan_id') !== "")): ?>
                                                            checked <?php endif; ?>
                                                        <div id="dailyDetails"
                                                            ...
                                                            <div class="form-group floating-label">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       placeholder="" value=""/>
                                                                <div class="error"
                                                                     style="color:red"><?php echo e($errors->first('daily_price')); ?></div>
                                                            </div>
                                                            <div class="form-group floating-label col-md-6 offset-md-6">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value=""/>
                                                                <div class="error"
                                                                     style="color:red"><?php echo e($errors->first('daily_billing_frequency')); ?></div>
                                                            </div>
                                                            <div class="form-group floating-label col-md-6">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value=""/>
                                                                <div class="error"
                                                                     style="color:red"><?php echo e($errors->first('billing_period')); ?></div>
                                                            </div>
                                                            ...
                                                            <div class="form-group floating-label col-md-6">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value=""/>
                                                                <div class="error"
                                                                     style="color:red"><?php echo e($errors->first('daily_post_limit')); ?></div>
                                                            </div>
                                                            <div class="form-group floating-label col-md-6">
                                                                <label class="control-label" style="color: black"
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value=""/>
                                                                <div class="error"
                                                                     style="color:red"><?php echo e($errors->first('daily_daily_post_limit')); ?></div>
                                                            </div>
                                                            ...
                                                            <div class="form-group floating-label">
                                                                ...
                                                                <div class="error"
                                                                     style="color:red"><?php echo e($errors->first('plan_type')); ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div id="weeklyDetails"
                                                            ...
                                                            <div class="form-group floating-label">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value="<?php echo e(old('weekly_price')); ?>"/>
                                                                <div class="error"
                                                                     style="color:red"><?php echo e($errors->first('weekly_price')); ?></div>
                                                            </div>
                                                            ...
                                                            <div class="form-group floating-label col-md-6">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value="<?php echo e(old('weekly_billing_frequency')); ?>"
                                                                       placeholder=""/>
                                                                <div class="error"
                                                                     style="color:red"><?php echo e($errors->first('weekly_billing_frequency')); ?></div>
                                                            ...
                                                            <div class="form-group floating-label col-md-6">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value=""/>
                                                                <div class="error"
                                                                     style="color:red"><?php echo e($errors->first('weeklybilling_period')); ?></div>
                                                            </div>
                                                            ...
                                                            <div class="form-group floating-label col-md-6">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       id="weeklypost_limit"
                                                                       min="1" max="" placeholder=""
                                                                       value="<?php echo e(old('weekly_post_limit')); ?>"/>
                                                                <div class="error"
                                                                     style="color:red"><?php echo e($errors->first('weekly_post_limit')); ?></div>
                                                            ...
                                                            <div class="form-group floating-label col-md-6">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value="<?php echo e(old('weekly_daily_post_limit')); ?>"
                                                                       placeholder=""/>
                                                                <div class="error"
                                                                     style="color:red"><?php echo e($errors->first('weekly_daily_post_limit')); ?></div>
                                                            ...
                                                            <div id="monthlyDetails"
                                                                ...
                                                                <div class="form-group floating-label">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           step="any" placeholder=""/>
                                                                    <div class="error"
                                                                         style="color:red"><?php echo e($errors->first('monthly_price')); ?></div>
                                                                ...
                                                                <div class="form-group floating-label col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           max=""
                                                                           value="<?php echo e(old('monthly_billing_frequency')); ?>"
                                                                           id="monthlybilling_frequency"
                                                                           placeholder=""/>
                                                                    <div class="error"
                                                                         style="color:red"><?php echo e($errors->first('monthly_billing_frequency')); ?></div>
                                                                ...
                                                                <div class="form-group floating-label col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           value=""/>
                                                                    <div class="error"
                                                                         style="color:red"><?php echo e($errors->first('monthlybilling_period')); ?></div>
                                                                </div>
                                                                ...
                                                                <div class="form-group floating-label col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           min="1" max="" placeholder=""
                                                                           value="<?php echo e(old('monthly_post_limit')); ?>"/>
                                                                    <div class="error"
                                                                         style="color:red"><?php echo e($errors->first('monthly_post_limit')); ?></div>
                                                                ...
                                                                <div class="form-group floating-label col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           max=""
                                                                           value="<?php echo e(old('monthly_daily_post_limit')); ?>"
                                                                           id="monthlydaily_post_limit"
                                                                           placeholder=""/>
                                                                    <div class="error"
                                                                         style="color:red"><?php echo e($errors->first('monthly_daily_post_limit')); ?></div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="error"
                                                 style="color:red"><?php echo e($errors->first('views_price')); ?></div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="error"
                                                 style="color:red"><?php echo e($errors->first('sub_package_type')); ?></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
