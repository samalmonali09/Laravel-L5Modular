                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <div style="float: right">
                            <a href="/admin/AddingUser/AUTOIG">
                        ...
                        <div class="table-container">
                            ...
                            <table class="table table-responsive table-striped table-bordered table-hover"
                                ...
                                <tr role="row" class="filter">
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-filter input-sm" title="search_id"
                                               name="search_id">
                                    </td>

                                    <td>
                                        <input type="text" class="form-control form-filter input-sm"
                                               title="search_username"
                                    ...
                                    <td>
                                        <div class="margin-bottom-5">
                                            <button class="btn btn-xs yellow filter-submit margin-bottom"
                                                    title="search"><i
                                                        class="fa fa-search" title="search"></i>
                                            </button>
...
// ChangeStatus Action  button Functionality in javascript
            $(document.body).on('click', '.changeStatus', function () {
                ...
                var y = confirm('Are you sure to Change Status ');
                if (y) {
                    $.ajax({
