...
<?php $__env->startSection('STAT','active open'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/manageUser/INSTASTAT">Manage Users</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/manageUser/INSTASTAT"><i class="fa fa-instagram"></i>INSTASTART</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <div style="float: right">
                            <a href="/admin/AddingUser/INSTASTAT">
...
//                    initPickers();
        ...
        $(document).ready(function () {
            ...
            $(document.body).on('click', '.changeStatus', function () {
                ...
                var data = $(this);
//            var ButtonStatus = parseInt(data.attr('data-status'));
