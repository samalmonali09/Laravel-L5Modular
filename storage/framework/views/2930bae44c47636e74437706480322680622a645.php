...
<?php $__env->startSection('Switch','active open'); ?>
...
<?php $__env->startSection('pagecontent'); ?>
    ...
    <div class="col-md-4">
        ...
        <div class="card" style="margin: 15px; border:1px solid #ccc; padding: 10px 10px 20px 10px; font-size: 16px;">
            Gift Icon Module <input data-toggle="toggle" type="checkbox" value="<?php echo e($gifticon); ?>" <?php echo ($gifticon=='ON')?'checked':''; ?> id="giftcheckbox" style="float: right;">
        </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        <div class="card" style="margin: 15px; border:1px solid #ccc; padding: 10px 10px 20px 10px; font-size: 16px;">
            Black Hat Module <input data-toggle="toggle" type="checkbox" value="<?php echo e($moduleswitch); ?>" <?php echo ($moduleswitch=='ON')?'checked':''; ?> id="Modulecheckbox" style="float: right;">
        </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        <div class="card" style="margin: 15px; border:1px solid #ccc; padding: 10px 10px 20px 10px; font-size: 16px;">
            Emergency Switch <input data-toggle="toggle" value="<?php echo e($emergencySwitch); ?>" <?php echo ($emergencySwitch=='ON')?'checked':''; ?> type="checkbox" id="EmergencySwitch" style="float: right;">
        </div>
    </div>
    ...
    <div class="col-md-6">
        ...
        <div class="card" style="margin: 15px; border:1px solid #ccc; padding: 10px 10px 20px 10px; font-size: 16px;">
            Activity Tracker <input data-toggle="toggle" type="checkbox" value="<?php echo e($Tracker); ?>" <?php echo ($Tracker=='ON')?'checked':''; ?> id="Trackcheckbox" style="float: right;">
        </div>
    </div>
