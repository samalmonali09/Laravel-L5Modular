...
<?php $__env->startSection('TrendApp','active'); ?>
<?php $__env->startSection('Hashtag1','active'); ?>
                            ...
                            <form method="post">
                                <div class="form-group ">
                                    ...
                                    <textarea name="summary" required class="form-control"
                                              id="summary-ckeditor"><?php echo e($data); ?></textarea>
                                </div>
                                <div class="row">
                                    <div>
                                        ...
                                        <div style="position:relative; display:inline-block">
                                            <span>BackGround ColorPiker:</span><input type="color" id="backgroudId" name="BGCOL" value=<?php echo e($bgColor); ?> >
                                        </div>
                                        <div style="position:relative; display:inline-block"><span>

                                            Title ColorPiker:</span><input type="color"  id="titleId"
                                                                           name="TTLCOL" value=<?php echo e($ttlColor); ?> />
                                        ...
                                        <div style="position:relative; display:inline-block"><span>
                                            ...
                                            Paragraph ColorPiker: </span><input type="color"  id="pId"
                                                                                name="CONTCOL" value=<?php echo e($pColor); ?> />
...
<?php $__env->startSection('pagescripts'); ?>
    ...
    <script>
        ...
        $(document.body).on('click', '#preview', function () {
            window.myVar = '<?php echo e(env('APP_URL')); ?>';
