...
<?php $__env->startSection('GIVRMO','active open'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/manageOrders/GIVR">Manage Orders</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/manageOrders/GIVR"><i class="fa fa-eye-slash"></i>Get Instant Views Russian </a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
