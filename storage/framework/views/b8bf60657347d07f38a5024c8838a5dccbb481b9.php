...
<?php $__env->startSection('STATO','active open'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="/admin/manageOrders/INSTASTAT">Manage Orders</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/admin/manageOrders/INSTASTAT"><i class="fa fa-instagram"></i> InstaStart</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
                            ...
                            <div class="table-container">
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover"
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            <select name="search_status" class="form-control form-filter input-sm" title="select">
                                                <option value="">select...</option>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" class="form-control form-filter input-sm"
                                                   name="method" value="INSTASTART" style="display: none;">
                                        </td>
            ...
            var handleRecords = function () {
                ...
                grid.getTableWrapper().on('click', '.table-group-action-submit', function (e) {
                    ...
                    if (action.val() != "" && grid.getSelectedRowsCount() > 0) {
                        ...
                        grid.setAjaxParam("method", "INSTASTART");
